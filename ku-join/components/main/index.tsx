...
const MainLayout = () => {
  ...
  if (
    data1 != undefined &&
    data2 != undefined &&
    data3?.contents.club_id == undefined &&
    data4 != undefined
  ) {
    if (data4.length == 0) {
      return (
                ...
                <WrapClubType>
                  ...
                  <WrapClub>
                    <ScrollContainer style={{ width: '70vw' }} vertical={false}>
                      ...
                      >
                        {data1 &&
                          data1.구기체육분과.map((club: ClubItem) => {
                            return (
                              <div
                                style={{
                                  width: '300px',
                ...
                <WrapClubType>
                  ...
                  <WrapClub>
                    <ScrollContainer style={{ width: '70vw' }} vertical={false}>
                      ...
                      >
                        {data1 &&
                          data1.레저무예분과.map((club: ClubItem) => {
                            return (
                              <div
                                style={{
                                  width: '300px',
                ...
                <WrapClubType>
                  ...
                  <WrapClub>
                    <ScrollContainer style={{ width: '70vw' }} vertical={false}>
                      ...
                      >
                        {data1 &&
                          data1.연행예술분과.map((club: ClubItem) => {
                            return (
                              <div
                                style={{
                                  width: '300px',
                ...
                <WrapClubType>
                  ...
                  <WrapClub>
                    <ScrollContainer style={{ width: '70vw' }} vertical={false}>
                      ...
                      >
                        {data1 &&
                          data1.인문사회분과.map((club: ClubItem) => {
                            return (
                              <div
                                style={{
                                  width: '300px',
                ...
                <WrapClubType>
                  ...
                  <WrapClub>
                    <ScrollContainer style={{ width: '70vw' }} vertical={false}>
                      ...
                      >
                        {data1 &&
                          data1.자연과학분과.map((club: ClubItem) => {
                            return (
                              <div
                                style={{
                                  width: '300px',
                ...
                <WrapClubType>
                  ...
                  <WrapClub>
                    <ScrollContainer style={{ width: '70vw' }} vertical={false}>
                      ...
                      >
                        {data1 &&
                          data1.창작비평분과.map((club: ClubItem) => {
                            return (
                              <div
                                style={{
                                  width: '300px',
          ...
          <WrapContents>
            <UserInfo>
              ...
              <WrapFriendList>
                ...
                <div>
                  {data4 &&
                    data4.map((Friends: FriendListItem) => {
                      return (
                        <div>
