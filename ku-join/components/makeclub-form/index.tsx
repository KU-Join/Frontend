...
const MakeClubForm = () => {
  ...
  return (
    <Container>
      <Form>
        <WrapForm>
          <LabelLeaderID htmlFor="leader_id" id="leader_id_label">
            대표자 ID
          </LabelLeaderID>
          <InputLeaderID
            type="text"
            ...
            name="leader_id"
            placeholder=""
            value={club.leader_id}
            onChange={handleInputChange}
          ></InputLeaderID>
          <LabelClubName htmlFor="club_name" id="club_name_label">
            동아리 이름
          </LabelClubName>
          <InputClubName
            type="text"
            ...
            onChange={handleInputChange}
          ></InputClubName>
          <LabelClubCategory htmlFor="category" id="category_label">
            동아리 분과
          </LabelClubCategory>
          <InputClubCategory
            type="text"
